...
export default function Produkte() {
    ...
    return (
        <>
        { produktPopup && <ShtoProduktPopup closePopup={() => showProduktPopup(false)} /> }
        <div className="produkte-header">
                ...
                <div className="produkte-header-item">
                        <div className="produkte-header-item-left">
                                ...
                                <p> {kategoria === "" ? "Asnje kategori e zgjedhur" : kategoria} </p>
                            </div>
                            <div className="produkte-header-item-right">
                                <LocalMallOutlinedIcon style={{fontSize:'40px'}} />
                            </div>
                ...
                <div className="produkte-header-item">
                    <h2>Shto produkt</h2>
                    <AddOutlinedIcon  onClick={() => showProduktPopup(true)} style={{cursor:'pointer',fontSize:'70px',color:'#e3e3e3',height:'70%'}} />
                </div>
        </div>
        <div className="data-table-produkte">
            <div className="data-table-produkte-header">
                <div className="data-table-produkte-header-left"> <h3>Produktet</h3></div>
                <div className="data-table-produkte-header-right">
                    <TextField style={{marginRight:'30px'}} size="small" variant="outlined" label="Kerko" placeholder="Kerko"></TextField>
                    <Button color="primary" onClick={() => showProduktPopup(true)} variant="contained" startIcon={<PostAddIcon style={{fontSize:'25px'}} />}>Shto Produkt</Button>
                </div>
            </div>
