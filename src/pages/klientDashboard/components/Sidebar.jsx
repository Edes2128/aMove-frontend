    ...
    <div className="klient-dashboard-sidebar">
      ...
      <div className="sidebar-links">
        ...
        <Link className="klient-dashboard-sidebar-link" to="/klient/porosite">
          {" "}
          <LocalMallOutlinedIcon style={{marginRight:'20px',fontSize:'27px'}}/> Porosite
        </Link>
        <Link className="klient-dashboard-sidebar-link" to="/klient/produktet">
          {" "}
          <FormatListBulletedOutlinedIcon style={{marginRight:'20px',fontSize:'27px'}}/> Produktet
        </Link>
        <Link className="klient-dashboard-sidebar-link" to="/klient/shporta">
          {" "}
          <ShoppingCartOutlinedIcon style={{marginRight:'20px',fontSize:'27px'}}/> Shporta
        </Link>
        <Link className="klient-dashboard-sidebar-link" to="/klient/wishlist">
          {" "}
          <StarBorderOutlinedIcon style={{marginRight:'20px',fontSize:'27px'}}/> Wishlist
        </Link>
      </div>
    </div>
  );
